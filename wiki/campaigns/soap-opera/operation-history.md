...
### 5. Operation Crop Dust

#### Brief

Intelligence gathered during Operation Raincrow has confirmed the presence of a fully active Los Zetas coca cultivation and processing site deep within Santa Arcadia’s southern interior. Surveillance from Bailiff’s preliminary recon shows terraced grow fields, makeshift guard posts, and at least one processing hut venting chemical fumes. Estimates suggest the farm has been operating for approximately one month, long enough for the cartel to establish reliable security patterns and supply lines—but not long enough to be heavily fortified. This is the ideal window to strike.

Bailiff will insert at first light and conduct a full assault on the coca farm, eliminating armed resistance, destroying crop beds and processing equipment, and securing any documents or electronic devices that may reveal supply routes or Zhenhua Capital involvement. Expect entrenched guards, hidden firing positions, possible booby traps, and drone overwatch. Once the site is neutralized, Bailiff will mark the area for follow-on destruction by Escrow or military engineers. This operation aims to cripple Los Zetas’ newest production hub before it becomes another permanent fixture of Santa Arcadia’s narco economy.

#### Outcome

Bailiff began the assault by clearing the fishing village adjacent to the AO, stopping a cartel RHIB from running supplies to an offshore fishing vessel. From there, the squad pushed inland through the coca fields, destroying several patches and engaging multiple cartel patrols, including two technicals attempting to flank their advance. Once at the suspected drug lab compound, Bailiff breached and cleared the site, eliminating remaining hostiles. Inside, they recovered the body of Dario Rodriguez, a known cartel chemist linked to regional production, along with a pallet of processed cocaine ready for transport. After securing evidence, Bailiff marked the compound and surrounding coca fields for thermal strikes, scheduled once the team safely extracted.

Bailiff extracted via Audit to Santa Arcadia International Airport to resume on-call status. Only a few hours later, Los Zetas launched a retaliatory offensive against SAPD positions in northern George Town. Bailiff was deployed to support the police and engaged multiple cartel infantry elements attempting to breach the DMZ perimeter. During the engagement, a cartel sniper wielding a .50 cal platform began firing on both SAPD and BSG. Bailiff maneuvered, closed distance, and eliminated the sniper, restoring stability to the perimeter. The squad held defensive positions until the situation subsided, concluding Operation Crop Dust.
